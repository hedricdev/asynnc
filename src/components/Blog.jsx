...
const posts = [
  {
    tag: 'Automação',
    title: 'Como reduzir retrabalho com automação de processos internos',
    summary:
      'Descubra como mapear os principais gargalos da sua operação e transformar tarefas repetitivas em fluxos automáticos que rodam sem intervenção humana.',
    readTime: '6 min',
    date: 'Jan 2025',
    href: '#',
  },
  {
    tag: 'Atendimento',
    title: '5 motivos pelos quais empresas perdem leads no WhatsApp (e como resolver)',
    summary:
      'A maioria dos leads esfria porque não há processo. Veja as falhas mais comuns no atendimento via WhatsApp e o que fazer para não perder mais oportunidades.',
    readTime: '5 min',
    date: 'Dez 2024',
    href: '#',
  },
  {
    ...
    summary:
      'Entender o impacto de sistemas isolados é o primeiro passo. Veja como integrações inteligentes eliminam redundância e dão visão unificada da operação.',
    readTime: '7 min',
    date: 'Nov 2024',
    href: '#',
  },
  {
    tag: 'Comercial',
    title: 'Funil automatizado: como nutrir leads sem esforço manual',
    summary:
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-14">
          ...
          <a
            ...
            style={{ color: '#FD4E0C' }}
            onMouseEnter={e => e.currentTarget.style.color = '#ff7040'}
            onMouseLeave={e => e.currentTarget.style.color = '#FD4E0C'}
          >
